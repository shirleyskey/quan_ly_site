<?php 
    ...
    $masv = $_POST["masv"];
    $lop = $_POST["lop"];  
    $sql = "SELECT * FROM `diem` WHERE `ma_sinh_vien` = '$masv'";
...
<table class="table table-bordered table-responsive">
                 ...
                 <tr>
                  ...
                  <td><?php 
                    $id_hk = $row["id_hoc_ky"];
                    $sqlhk = "SELECT * FROM `hoc_ky` WHERE `id_hoc_ky` = '$id_hk'";
                    $qrhk = mysqli_query($conn, $sqlhk);
                    $rowhk = mysqli_fetch_assoc($qrhk);
                   echo  ($rowhk["ten_hoc_ky"]." - ".$rowhk["ten_lop"]);
                  ?></td>
  ...
  <div class="modal-dialog">
      <div class="modal-content">
        ...
        <table class="table table-bordered">
          ...
          <!-- <input type="text" name="" id="hockydiem" class="hidden"> -->
